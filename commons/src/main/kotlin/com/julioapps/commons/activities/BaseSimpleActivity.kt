...
import com.julioapps.commons.helpers.APP_LICENSES
import com.julioapps.commons.helpers.APP_NAME
import com.julioapps.commons.helpers.APP_VERSION_NAME
import com.julioapps.commons.helpers.OPEN_DOCUMENT_TREE
import java.io.File
import java.util.*
...
open class BaseSimpleActivity : AppCompatActivity() {
        ...
        if (!packageName.startsWith("com.simplemobiletools.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                ...
                com.julioapps.commons.dialogs.ConfirmationDialog(this, label, positive = R.string.ok, negative = 0) {
                    launchViewIntent("https://play.google.com/store/")
                }
            }
        }
    }
    ...
    override fun onDestroy() {
        super.onDestroy()
        com.julioapps.commons.activities.BaseSimpleActivity.Companion.funAfterSAFPermission = null
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, resultData: Intent?) {
        ...
        if (requestCode == OPEN_DOCUMENT_TREE && resultCode == Activity.RESULT_OK && resultData != null) {
            if (isProperFolder(resultData.data)) {
                ...
                com.julioapps.commons.activities.BaseSimpleActivity.Companion.funAfterSAFPermission?.invoke()
            } else {
    ...
    fun startAboutActivity(appNameId: Int, licenseMask: Int, versionName: String) {
        Intent(applicationContext, com.julioapps.commons.activities.AboutActivity::class.java).apply {
    ...
    fun startCustomizationActivity() = startActivity(Intent(this, com.julioapps.commons.activities.CustomizationActivity::class.java))
    ...
    fun handleSAFDialog(file: File, callback: () -> Unit): Boolean {
        return if (isShowingSAFDialog(file, baseConfig.treeUri, OPEN_DOCUMENT_TREE)) {
            com.julioapps.commons.activities.BaseSimpleActivity.Companion.funAfterSAFPermission = callback
            true
        } else {
            callback()
            false
    ...
    private fun startCopyMove(files: ArrayList<File>, destinationFolder: File, isCopyOperation: Boolean, copyPhotoVideoOnly: Boolean) {
        ...
        com.julioapps.commons.asynctasks.CopyMoveTask(this, isCopyOperation, copyPhotoVideoOnly, copyMoveListener).execute(pair)
    }
    ...
    val copyMoveListener = object : com.julioapps.commons.asynctasks.CopyMoveTask.CopyMoveListener {

package com.julioapps.commons.activities
...
import com.julioapps.commons.models.MyTheme
import com.julioapps.commons.models.RadioItem
import com.julioapps.commons.models.SharedTheme
import kotlinx.android.synthetic.main.activity_customization.*
import java.util.*

class CustomizationActivity : com.julioapps.commons.activities.BaseSimpleActivity() {
    ...
    private var curPrimaryLineColorPicker: com.julioapps.commons.dialogs.LineColorPickerDialog? = null
    ...
    private fun setupThemePicker() {
        ...
        customization_theme_holder.setOnClickListener {
            ...
            com.julioapps.commons.dialogs.RadioGroupDialog(this@CustomizationActivity, items, curSelectedThemeId) {
                if (it == THEME_SHARED && !isThankYouInstalled()) {
                    com.julioapps.commons.dialogs.PurchaseThankYouDialog(this)
    ...
    private fun promptSaveDiscard() {
        com.julioapps.commons.dialogs.ConfirmationAdvancedDialog(this, "", R.string.save_before_closing, R.string.save, R.string.discard) {
            if (it) {
                saveChanges(true)
            } else {
                resetColors()
    ...
    private fun pickTextColor() {
        com.julioapps.commons.dialogs.ColorPickerDialog(this, curTextColor) {
    ...
    private fun pickBackgroundColor() {
        com.julioapps.commons.dialogs.ColorPickerDialog(this, curBackgroundColor) {
    ...
    private fun pickPrimaryColor() {
        ...
        curPrimaryLineColorPicker = com.julioapps.commons.dialogs.LineColorPickerDialog(this, curPrimaryColor) { wasPositivePressed, color ->
    ...
    private fun applyToAll() {
        if (isThankYouInstalled()) {
            com.julioapps.commons.dialogs.ConfirmationDialog(this, "", R.string.share_colors_success, R.string.ok, 0) {
                Intent().apply {

...
import com.julioapps.commons.interfaces.MyAdapterListener
import com.julioapps.commons.views.FastScroller
import com.julioapps.commons.views.MyRecyclerView
import java.util.*

abstract class MyRecyclerViewAdapter(val activity: com.julioapps.commons.activities.BaseSimpleActivity, val recyclerView: MyRecyclerView, val fastScroller: FastScroller? = null,
                                     val itemClick: (Any) -> Unit) : RecyclerView.Adapter<com.julioapps.commons.adapters.MyRecyclerViewAdapter.ViewHolder>() {
    ...
    fun createViewHolder(layoutType: Int, parent: ViewGroup?): com.julioapps.commons.adapters.MyRecyclerViewAdapter.ViewHolder {
        val view = layoutInflater.inflate(layoutType, parent, false)
        return com.julioapps.commons.adapters.MyRecyclerViewAdapter.ViewHolder(view, adapterListener, activity, multiSelectorMode, multiSelector, itemClick)
    }

    fun bindViewHolder(holder: com.julioapps.commons.adapters.MyRecyclerViewAdapter.ViewHolder, position: Int, view: View) {
    ...
    class ViewHolder(view: View, val adapterListener: MyAdapterListener, val activity: com.julioapps.commons.activities.BaseSimpleActivity, val multiSelectorCallback: ModalMultiSelectorCallback,

package com.julioapps.commons.asynctasks
...
class CopyMoveTask(val activity: com.julioapps.commons.activities.BaseSimpleActivity, val copyOnly: Boolean = false, val copyMediaOnly: Boolean,
                   listener: com.julioapps.commons.asynctasks.CopyMoveTask.CopyMoveListener) : AsyncTask<Pair<ArrayList<File>, File>, Void, Boolean>() {
    private var mListener: WeakReference<com.julioapps.commons.asynctasks.CopyMoveTask.CopyMoveListener>? = null

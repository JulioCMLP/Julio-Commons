...
import com.julioapps.commons.views.Breadcrumbs
 ...
 */
class FilePickerDialog(val activity: com.julioapps.commons.activities.BaseSimpleActivity,
    ...
    private fun createNewFolder() {
        com.julioapps.commons.dialogs.CreateNewFolderDialog(activity, currPath) {
            callback(it.trimEnd('/'))
            mDialog.dismiss()
        }
    }
    ...
    private fun updateItems() {
        ...
        val adapter = com.julioapps.commons.adapters.FilepickerItemsAdapter(activity, items, mDialogView.filepicker_list) {
    ...
    override fun breadcrumbClicked(id: Int) {
        if (id == 0) {
            com.julioapps.commons.dialogs.StoragePickerDialog(activity, currPath) {
                currPath = it
                updateItems()
            }
        } else {

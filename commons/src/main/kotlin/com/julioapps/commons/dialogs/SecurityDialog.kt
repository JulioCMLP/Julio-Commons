...
import com.julioapps.commons.helpers.PROTECTION_FINGERPRINT
import com.julioapps.commons.helpers.PROTECTION_PATTERN
import com.julioapps.commons.helpers.PROTECTION_PIN
import com.julioapps.commons.helpers.SHOW_ALL_TABS
import com.julioapps.commons.interfaces.HashListener
import com.julioapps.commons.views.MyDialogViewPager
...
class SecurityDialog(val activity: Activity, val requiredHash: String, val showTabIndex: Int, val callback: (hash: String, type: Int, success: Boolean) -> Unit)
    ...
    lateinit var tabsAdapter: com.julioapps.commons.adapters.PasswordTypesAdapter
    ...
    init {
        view.apply {
            ...
            tabsAdapter = com.julioapps.commons.adapters.PasswordTypesAdapter(context, requiredHash, this@SecurityDialog)

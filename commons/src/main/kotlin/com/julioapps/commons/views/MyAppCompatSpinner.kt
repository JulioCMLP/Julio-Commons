...
import com.julioapps.commons.extensions.applyColorFilter
...
class MyAppCompatSpinner : AppCompatSpinner {
    ...
    fun setColors(textColor: Int, accentColor: Int, backgroundColor: Int) {
        ...
        adapter = com.julioapps.commons.adapters.MyArrayAdapter(context, android.R.layout.simple_spinner_item, items, textColor, backgroundColor, padding)
